			...
			<div className="emps-list">
				...
				{this.props.appData.emps ? Object.keys(this.props.appData.emps).map((id, index) => (
					<EmpBlock 
						...
						isActive={this.props.activeItem &&this.props.activeItem.login == this.props.appData.emps[id].login} 
				...
				{ this.state.formIsShown ? <EmpAddForm positions={this.props.appData.positions} hideForm={this.hideForm} newEmp={this.props.newEmp} /> : null }
			</div>
		);
	}
}
